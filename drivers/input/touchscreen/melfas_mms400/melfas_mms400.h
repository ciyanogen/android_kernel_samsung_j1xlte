...
//Firmware update
#define INTERNAL_FW_PATH		"tsp_melfas/mms438_o5.fw"
#ifdef CONFIG_TOUCHSCREEN_MELFAS_MMS438_USE_DUAL_FW
#define INTERNAL_FW_PATH_VE		"tsp_melfas/mms438_o5_ve.fw"
#endif
...
#ifdef CONFIG_TOUCHSCREEN_MELFAS_MMS438_USE_DUAL_FW
	int pass_cnt;
	int hwcat;	// 0 = Unknown, 1 = Old, 2 = New(ALL ITO)
	int module;	// 0 = Unknown, 1 = Old, 2 = New(ALL ITO)
	bool force_update_matched_fw;
	bool confirmed;
#endif
};
